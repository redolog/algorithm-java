...
public class DefuseTheBombTest {
    ...
    public void decrypt() {
        ...
        DefuseTheBomb.SlidingWindow slidingWindow = new DefuseTheBomb.SlidingWindow();
        assertArrayEquals(new int[]{12, 10, 16, 13}, slidingWindow.decrypt(new int[]{5, 7, 1, 4}, 3));
        assertArrayEquals(new int[]{0, 0, 0, 0}, slidingWindow.decrypt(new int[]{1, 2, 3, 4}, 0));
        assertArrayEquals(new int[]{12, 5, 6, 13}, slidingWindow.decrypt(new int[]{2, 4, 9, 3}, -2));
    }
}