...
public class ConvertBst2GreaterTreeTest {
    ...
    public void convertBST() {
        ...
        Assert.assertEquals(TreeNode.buildAnyWithArr(new Integer[]{30, 36, 21, 36, 35, 26, 15, null, null, null, 33, null, null, null, 8}), service.convertBST(TreeNode.buildAnyWithArr(new Integer[]{4, 1, 6, 0, 2, 5, 7, null, null, null, 3, null, null, null, 8})));
